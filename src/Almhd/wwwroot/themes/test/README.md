...
## Standard Theme
The Standard theme comes with the Almhd v3.0 with awesome features and customization. This theme has been built with Bootstrap v5.0 with no jQuery.

## Customization

Login to your Almhd's admin panel, navigate to Settings > Customize. In the Customize page in the settings tab, you are able to customize:
...
Check out the **[Almhd Official Website >](https://Almhd.net/)**
